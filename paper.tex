...
Among the 51 systems which were not significantly different from the highest-accuracy system on the ``easy'' dataset, the highest achieved correlation was .7098.
